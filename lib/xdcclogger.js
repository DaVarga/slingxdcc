    ...
    this.getIrcServers = function (){
        ...
        serverDb.forEach(function (key, val){
            if (typeof val !== "undefined"){
                servers[key] = clone(val);
                servers[key].error = [];
                servers[key].connected = false;
                servers[key].motd = "";
                if (typeof ircServers[key] !== "undefined"){
                    if (typeof ircServers[key].error !== "undefined"){
                        servers[key].error = clone(ircServers[key].error);
                    }
                    servers[key].motd = ircServers[key].motd;
                }
