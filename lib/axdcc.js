...
handle.start = function () {
    ...
    if (client.nick) {//TODO: connected?!
        ...
        client.once("registered", this.triggerDownload.bind(this));
    }
...
class Axdcc extends EventEmitter {
    ...
    constructor(client, opts) {
        ...
        this.on("start", handle.start.bind(this));
    }
    ...
    triggerDownload() {
        ...
        client.on("message", handle.message.bind(this));
        client.on("notice", handle.message.bind(this));
        client.on("ctcp-privmsg", handle.message.bind(this));
        client.on("ctcp-notice", handle.message.bind(this));
        client.on("ctcp-privmsg", handle.dccMessage.bind(this));
    ...
    unregister() {
        ...
        client.removeListener("message", handle.message.bind(this));
        client.removeListener("notice", handle.message.bind(this));
        client.removeListener("ctcp-privmsg", handle.message.bind(this));
        client.removeListener("ctcp-notice", handle.message.bind(this));
        client.removeListener("ctcp-privmsg", handle.dccMessage.bind(this));
